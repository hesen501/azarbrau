...
@section('content')
    ...
    <section id="home">
        <div class="container home-1">
            <div class="row">
                <img src="front/img/logo2-azabrau.png" alt="">
                <p class="home-text">
        ...
        <div class="container">
            <div class="row">
                <div class="col-5">
                    ...
                    <div class="texture-1">
                        <img src="front/img/texture-1.png" alt="">
                    </div>
                </div>
                <div class="col-6">
                    <img src="front/img/about-img.png" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="products">
        ...
        <div class="texture-2">
            <img src="front/img/texture-2.png" alt="">
        </div>
    </section>
    <!--Products End-->
    <!--Home Gif Start-->
    <section id="home-gif">
        <div class="gif">
            <img src="front/img/home-gif.gif" alt="">
            <div class="container">
                <div class="row">
                    <div class="gif-text">
                        <h2 class="gif-head">
    ...
    <section id="brends">
        <div class="container">
            <div class="row">
                ...
                <div class="brends">
                    <img src="front/img/brends.png" alt="">
                    <div class="container">
                        <div class="az-brends">
                            <h3 class="az-head">
                                AZERBAYCAN
        ...
        <div class="owl-carousel owl-theme news-slider">
            <div class="item">
                <a href="#">
                    ...
                    <div class="texture-3">
                        <img src="front/img/texture-3.png" alt="">
                    </div>
                    <div class="texture-4">
                        <img src="front/img/texture-4.png" alt="">
                    </div>
                </a>
            </div>
        </div>
